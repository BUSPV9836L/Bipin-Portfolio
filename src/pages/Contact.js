...
export const Contact = () => {
  return (
    <div id="contact" className="flex-col h-full w-[460px] sm:w-[600px] md:w-[1200px] px-4 py-6 bg-gradient-to-tr from-purple-600 to-orange-500 rounded-lg mx-auto mt-5">
